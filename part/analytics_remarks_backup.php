...
$queryRooms = "SELECT room, COUNT(*) as count FROM records_issue GROUP BY room ASC";
...
$queryPCs = "SELECT pc_id, COUNT(*) as count FROM records_issue GROUP BY pc_id ASC";
    ...
    <div class="card card-flush mb-5 mb-xl-10" style="width: 25%; height: 100%; margin-right: 2px;">
        <div class="card-header pt-5">
            <div class="card-title d-flex flex-column">
                ...
                <span class="text-gray-500 pt-1 fw-semibold fs-6">Remarks Count by Room</span>
            </div>
        </div>
            ...
            <div class="card-title d-flex flex-column">
                <div class="d-flex align-items-center">
                    ...
                    <span class="fs-4 fw-semibold me-1 align-self-start">
                        <img width="23" height="23" src="error.png" alt="workstation"/>
                    </span>
                </div>
    ...
    options: {
        ...
        onClick: function(evt) {
            ...
            if (activePoints.length > 0) {
                ...
                alert(`PC: ${label}, Remarks Count: ${value}`);
            }
        }
    },
    plugins: [ChartDataLabels]
